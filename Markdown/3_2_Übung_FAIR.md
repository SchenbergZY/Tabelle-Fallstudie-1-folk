...
Um Daten auf ihre FAIRness zu prüfen, bieten sich Checklisten an. Diese Übung bezieht sich auf die Checkliste von Jones & Grootveld (2017) {cite:p}`jones_how_2017`, die Sie unter folgendem Link bei Zenodo auf Englisch einsehen können: <a href="https://zenodo.org/records/5111307" target="_blank">https://zenodo.org/records/5111307</a>. Für diese Übung wurde das Dokument übersetzt. 
